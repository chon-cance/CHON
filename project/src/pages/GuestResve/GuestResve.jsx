...
export default function GuestResve() {
  ...
  const fetchReservationData = async () => {
    try {
      const response = await fetch(
        `https://port-0-chon-m3qz4omzb344e0d7.sel4.cloudtype.app/reservations/?reservationId=${id}`
      );
  ...
  async function reservationDelete() {
    ...
    if (confirmCancel.isConfirmed) {
      ...
      try {
        const response = await fetch(
          `https://port-0-chon-m3qz4omzb344e0d7.sel4.cloudtype.app/reservations/delete/${id}`,
          {
